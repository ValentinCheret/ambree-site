...
const translations = {
  fr: {
    ...
    "legal.data.body1": "Ce site ne collecte actuellement aucune donnée personnelle par formulaire : les prises de contact se font par appel téléphonique ou email, à l'initiative du visiteur. Si un formulaire de contact ou un outil de mesure d'audience est ajouté ultérieurement, cette section sera mise à jour pour préciser les données collectées, leur finalité, leur durée de conservation et les modalités d'exercice des droits d'accès, de rectification et de suppression prévus par le RGPD.",
  ...
  en: {
    ...
    "legal.data.body1": "This site does not currently collect any personal data through a form: visitors get in touch by phone call or email, at their own initiative. If a contact form or an audience-measurement tool is added later, this section will be updated to specify what data is collected, its purpose, how long it is kept, and how to exercise your rights of access, correction, and deletion under the GDPR.",
